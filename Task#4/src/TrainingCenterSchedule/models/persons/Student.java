...
public class Student {
    ...
    public Student(String firstName, String lastName, Curriculum curriculum, String dateTime){
        this.firstName=firstName;
        this.lastName=lastName;
        this.curriculum=curriculum;
        this.startDate = LocalDateTime.parse(dateTime,DateTimeFormatter.ofPattern(DATETIME_FORMAT));
    }
